...
namespace Model
{
    ...
    public partial class Z_Student
    {
        public string F_ID { get; set; }
        public string F_StuName { get; set; }
        public string Z_C_F_Id { get; set; }
        public string F_StuNo { get; set; }
        public string F_StuPhone { get; set; }
        public string F_StuPassword { get; set; }
        ...
        public virtual Z_Class Z_Class { get; set; }
    }
}
